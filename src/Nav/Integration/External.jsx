      ...
      <section className="aasandha-hero">
        ...
        <div className="hero-left">
          <h1>
            ...
            System (CDSS) for Hospitals and Clinics
          </h1>
         
          <p className="hero-description">
           MocDoc’s Hospital Management Software, now powered by a Clinical Decision Support System (CDSS), enables doctors across India to make faster, safer, and evidence-based clinical decisions. By delivering real-time diagnostic suggestions, medication guidance, and alerts on contraindications, MocDoc helps reduce medical errors and improve patient outcomes. Designed to support high-quality care in both urban hospitals and rural clinics, our CDSS-driven platform ensures guideline-based treatment for chronic conditions like diabetes and hypertension.
          </p>
        ...
        <div className="hero-right">
          <img src="/cdss.png" className="doctor-main" alt="Doctor" />
        </div>
